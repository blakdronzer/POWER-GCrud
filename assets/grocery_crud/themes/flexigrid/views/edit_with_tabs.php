...
<div id='main-table-box'>
	...
	<div class="form-actions" style="margin-left:20px; margin-top:-20px">
		<div class='form-button-box'>
			<input class='btn btn-primary btn-large' id="form-button-save" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-large"/>
		</div>
<?php 	if(!$this->unset_back_to_list) { ?>
		<div class='form-button-box'>
			<input class='btn btn-darkblue btn-large' type='button' value='<?php echo $this->l('form_update_and_go_back'); ?>' id="save-and-go-back-button" class="btn btn-large"/>
		</div>
		<div class='form-button-box'>
			<input class='btn btn-danger btn-large' type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-large" id="cancel-button" />
		</div>
<?php 	} ?>
		<div class='form-button-box'>
